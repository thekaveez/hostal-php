...
<body>
    ...
    <div class="page-header default-template-gradient">
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    <h2 class="page-title">Hostels</h2>
                    <p class="page-description">More Details About Hostel</p>
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div><!-- /.page-header -->
        							...
        							<div class="form-bg seven">
        								<div class="form-content">
        									...
        									<div class="form-group">
        		                                ...
        		                                <textarea name="yourmessage" minlength="2" maxlength="2000"  placeholder="Please Write Some Message"autocomplete="off" class="form-controller"></textarea><br>
