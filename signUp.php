        ...
        <div class="form-left">
            ...
            <p>
				...
				<div style="margin-left:20px;"class="card-box mb-20">
					...
					<div class="pd-2">
						<center><h1 class="text-blue h4">Register</h1></center>
					</div>
					<div class="pb-20">
...
<!--            <h2 class="text-uppercase">Registration form</h2>-->
			<h4 ><span><?php echo $message; ?></span></h4>
               ...
               <div class="mb-3">
                    <label>Phone</label>
                    <input type="text" value="<?php echo $phone;?>" autocomplete="off" title="Please enter valid phone number" name="phone" id="phone" required class="input-field">
                </div> 
       <br>
            <div class="mb-3">
